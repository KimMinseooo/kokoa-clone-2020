...
function makeTodo(text,checked){
    ...
    div1.classList.add('user-component','js-todo-list');
    div1.id = newId;
    div2.classList.add('user-component__column');
    div2b.classList.add('user-component__column');
    div3.classList.add('user-component__text');
